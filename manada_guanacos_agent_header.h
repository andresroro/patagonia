/**
 * \file  manada_guanacos_agent_header.h
...
/** \def CALORIAS
 * \brief Direct access to calorias of manada_guanacos agent memory variable. */
#define CALORIAS (current_xmachine_manada_guanacos->calorias)
/** \def ADULTOS
